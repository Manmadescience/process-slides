...
\begin{frame}{Stylechecking}
	\begin{itemize}
		\item Einheitliche Formatierung
			...
			\end{itemize}
		\item Merge-Konflikte vermeiden
		\item Disziplin
	\end{itemize}
\end{frame}

\begin{frame}{Stylechecking: Python}
	\begin{itemize}
		\item Minimalsatz an Regeln ausarbeiten		
		\item \texttt{PEP\,8} und \texttt{Pylint}
		\item Automatisches Stylechecking vor dem Commit bereits eingerichtet
...
\begin{frame}{Stylechecking: Javascript}
	\begin{itemize}
		\item Anwendung:
			\begin{itemize}
...
\begin{frame}{Nightly Builds}
	\begin{itemize}
		\item Der Build-Prozess fehlt
			...
			\end{itemize}
		\item Integration mit Jenkins
			\begin{itemize}
				\item Cron-Job, startet um 23 Uhr
				\item Baut \texttt{develop} und \texttt{release}
				\item Setzt Tags in \texttt{Git} (Version usw)
				\item F"uhrt Unit Tests aus
				\item F"uhrt Integration Tests aus
...
\begin{frame}{Versionierung}
	\begin{equation*}
		\underbrace{1}_{\text{Major}}.\underbrace{5}_{\text{Minor}}.\underbrace{11}_{\text{Features}}.\underbrace{255}_{\text{Survived Days}}
	\end{equation*}
	\vfill
	\begin{description}[Survived Days:]
		\item[Major:] Version vom letzten Release
		\item[Minor:] Bugfixes f"ur das letzte Release
