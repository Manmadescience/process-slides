...
\tikzstyle{tag}=[draw,rectangle,fill=white,inner sep=.5ex,minimum width=2ex, minimum height=2ex]
...
\node[tag,right,xshift=.1] (v1.0) at (label_9271ce9.east) {\verb!v1.0!};
\node[tag,right,xshift=.1] (v2.0) at (label_966a68d.east) {\verb!v2.0!};
\end{tikzpicture}